// src/components/global/Ayur3pNavbar.jsx
import React, { useState, useEffect } from 'react';
import { Link, useLocation } from 'react-router-dom';
import { Menu, X } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

export default function Ayur3pNavbar() {
  ...
  const navItems = [
    { name: 'Story', path: '/ayur3p/about' },
    { name: 'Science', path: '/ayur3p/science' },
    { name: 'Manufacturing Process', path: '/ayur3p/process' },
    { name: 'Products', path: '/ayur3p/products' },
    { name: 'Contact', path: '/ayur3p/contact' }
  ];
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <Link to="/ayur3p" className="flex items-center group relative">
            <motion.div
            ...
            >
              <img 
                src="/ayur3p b.png" 
                alt="Ivy Herbals Ayurvedic Logo" 
