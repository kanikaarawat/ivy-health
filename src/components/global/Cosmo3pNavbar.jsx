// src/components/global/Cosmo3pNavbar.jsx
import React, { useState, useEffect } from 'react';
import { Link, useLocation } from 'react-router-dom';
import { Menu, X } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

export default function Cosmo3pNavbar() {
  ...
  const navItems = [
    { name: 'Story', path: '/cosmo3p/about' },
    { name: 'Science', path: '/cosmo3p/science' },
    { name: 'Manufacturing Process', path: '/cosmo3p/process' },
    { name: 'Products', path: '/cosmo3p/products' },
    { name: 'Contact', path: '/cosmo3p/contact' }
  ];
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <Link to="/cosmo3p" className="flex items-center group relative">
            <motion.div
            ...
            >
              <img 
                src="/cosmo3p b.png" 
                alt="Ivy Herbals Cosmetics Logo" 
